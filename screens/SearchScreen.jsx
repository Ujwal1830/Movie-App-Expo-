import { View, Text, Dimensions, TextInput, ScrollView, TouchableWithoutFeedback, Image, TouchableOpacity } from 'react-native'
...
export default function SearchScreen() {
  ...
  return (
    <SafeAreaView className="bg-black flex-1 pt-4">
